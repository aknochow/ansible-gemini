# Contributing to ansible-gemini
...
maps that layout into `site-packages/ansible_collections/aknochow/gemini/`.
The PyPI name is `aknochow-gemini` (not `ansible-gemini` — Ansible trademark).
